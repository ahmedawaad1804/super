...
export default OrderItem = (data) => {
    ...
    return (
        ...
        <View style={styles.orderOpacity}>
            ...
            <Text>Name : {data.src.customerId ? data.src.customerId.username : "not exist"}</Text>
            ...
            <Text>Order Number : {data.src.orderTimeID}</Text>
            <Text>Order Status : {data.src.status}</Text>
